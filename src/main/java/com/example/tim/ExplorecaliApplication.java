...
import com.example.tim.domain.Difficulty;
import com.example.tim.domain.Region;
import com.example.tim.service.TourPackageService;
import com.example.tim.service.TourService;
...
public class ExplorecaliApplication implements CommandLineRunner {
	...
	//To implement CommandLineRunner we need to provide run()
	// Since the run method is object scope we can access the injected services
	@Override
	...
	/**
	 * Create tour entities from an external JSON file
	 */
